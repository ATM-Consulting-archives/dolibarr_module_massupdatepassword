...
/**
 * 	\defgroup	massupdatepassword	MassUpdatePassword module
 * 	\brief		MassUpdatePassword module descriptor.
 * 	\file		core/modules/modMassUpdatePassword.class.php
 * 	\ingroup	massupdatepassword
 * 	\brief		Description and activation file for module MassUpdatePassword
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module MassUpdatePassword
 */
class modMassUpdatePassword extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->picto = 'massupdatepassword@massupdatepassword'; // mypicto@massupdatepassword
        // Defined all module parts (triggers, login, substitutions, menus, css, etc...)
        // for default path (eg: /massupdatepassword/core/xxxxx) (0=disable, 1=enable)
        // for specific path of parts (eg: /massupdatepassword/core/modules/barcode)
        // for specific css file (eg: /massupdatepassword/css/massupdatepassword.css.php)
        ...
        // Example: this->dirs = array("/massupdatepassword/temp");
        $this->dirs = array();

        // Config pages. Put here list of php pages
        // stored into massupdatepassword/admin directory, used to setup module.
        $this->config_page_url = array("admin_massupdatepassword.php@massupdatepassword");
       ...
       $r++;
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@massupdatepassword:$user->rights->massupdatepassword->read:/massupdatepassword/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@massupdatepassword:$user->rights->othermodule->read:/massupdatepassword/mynewtab2.php?id=__ID__',
        ...
        // Dictionnaries
        if (! isset($conf->massupdatepassword->enabled)) {
        	$conf->massupdatepassword = ( object ) array ();
            $conf->massupdatepassword->enabled = 0;
        }
        $this->dictionnaries = array();
        /* Example:
          // This is to avoid warnings
          if (! isset($conf->massupdatepassword->enabled)) $conf->massupdatepassword->enabled=0;
          $this->dictionnaries=array(
          'langs'=>'massupdatepassword@massupdatepassword',
          ...
          'tabcond'=>array(
          $conf->massupdatepassword->enabled,
          $conf->massupdatepassword->enabled,
          $conf->massupdatepassword->enabled
          )
          );
        ...
        //	'type'=>'top',
        //	'titre'=>'MassUpdatePassword top menu',
        //	'mainmenu'=>'massupdatepassword',
        //	'leftmenu'=>'massupdatepassword',
        //	'url'=>'/massupdatepassword/pagetop.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
        //	// Define condition to show or hide menu entry.
        //	// Use '$conf->massupdatepassword->enabled' if entry must be visible if module is enabled.
        //	'enabled'=>'$conf->massupdatepassword->enabled',
        //	// Use 'perms'=>'$user->rights->massupdatepassword->level1->level2'
        ...
        //	'type'=>'left',
        //	'titre'=>'MassUpdatePassword left menu',
        //	'mainmenu'=>'massupdatepassword',
        //	'leftmenu'=>'massupdatepassword',
        //	'url'=>'/massupdatepassword/pagelevel1.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
        ...
        //	'leftmenu'=>'massupdatepassword',
        //	'url'=>'/massupdatepassword/pagelevel2.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
     ...
     * and create data commands must be stored in directory /massupdatepassword/sql/
    ...
    {
        return $this->_load_tables('/massupdatepassword/sql/');
    }
}
